...
run: ## run the API server
	...
	-p 11000:11000 php5.6 php -S 0.0.0.0:11000 -t /var/www
...
db-start: ## start the database server
	...
	-v $(shell pwd)/testdata/mysql:/var/lib/mysql  -e MYSQL_ROOT_PASSWORD=bolo \
	-e MYSQL_DATABASE=schools -d -p 3306:3306 mariadb:10.1
